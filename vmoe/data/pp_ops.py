...
from vmoe.cloud_tpu.models.official.efficientnet import autoaugment

# try:
#   from vmoe.cloud_tpu.models.official.efficientnet import autoaugment  # pylint: disable=g-import-not-at-top
# except ImportError:
#   print("NOT FOUND")
#   autoaugment = None
