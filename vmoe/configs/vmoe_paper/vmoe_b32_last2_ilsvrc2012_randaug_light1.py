...
TFDS_DATA_DIR = None
TFDS_MANUAL_DIR = "/root/tensorflow_datasets/downloads/manual/"
NUM_CLASSES = 1_000
# BATCH_SIZE = 8192
BATCH_SIZE = 2048
...
def get_config():
  """Config to train V-MoE B/32 on ILSVRC2012 from scratch."""
  ...
  config.description = 'ViT-B/32, E=8, K=2, Every 2, 300 Epochs, Base'
  ...
  # Mixup options.
  config.mixup = common.get_mixup_config('strong1')
